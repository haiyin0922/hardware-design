...
HD_PWD='C:/player2control/player2control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log player2control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source player2control.tcl -notrace
