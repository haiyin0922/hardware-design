...
HD_PWD='C:/player2control/player2control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log player2control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source player2control.tcl
