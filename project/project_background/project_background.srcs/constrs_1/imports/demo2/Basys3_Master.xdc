...
##Pmod Header JB
##Sch name = JB1
#    set_property PACKAGE_PIN A14 [get_ports {button_UP}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {button_UP}]
##Sch name = JB2
#    set_property PACKAGE_PIN A16 [get_ports {button_DOWN}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {button_DOWN}]
##Sch name = JB3
#    set_property PACKAGE_PIN B15 [get_ports {button_LEFT}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {button_LEFT}]
##Sch name = JB4
#    set_property PACKAGE_PIN B16 [get_ports {button_RIGHT}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {button_RIGHT}]
##Sch name = JB7
#    set_property PACKAGE_PIN A15 [get_ports {button_ATTACK}]
...
##Pmod Header JC
    ...
    ##Sch name = JC7
        ...
        set_property IOSTANDARD LVCMOS33 [get_ports {button_ATTACK}]
    ##Sch name = JC8
        #set_property PACKAGE_PIN M19 [get_ports {rstt}]
        #set_property IOSTANDARD LVCMOS33 [get_ports {rstt}]
    ##Sch name = JC9
        #set_property PACKAGE_PIN P17 [get_ports {startt}]
        #set_property IOSTANDARD LVCMOS33 [get_ports {startt}]
    ##Sch name = JC10
