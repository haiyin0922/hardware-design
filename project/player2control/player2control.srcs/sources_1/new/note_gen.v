...
assign audio_left = (note_div_b == 22'd1000) ? 16'h0000 : (b_clk == 1'b0) ? 16'h8001 :
                    (volume[2] == 1)? 16'h7FFF: (volume[1] == 1)? 16'hD556 : (volume[0] == 1)? 16'h8FFF : 16'h0000;
assign audio_right = (note_div_c == 22'd1000) ? 16'h0000 : (c_clk == 1'b0) ? 16'h8001 :
                     (volume[2] == 1)? 16'h7FFF: (volume[1] == 1)? 16'hD556 : (volume[0] == 1)? 16'h8FFF : 16'h0000;
